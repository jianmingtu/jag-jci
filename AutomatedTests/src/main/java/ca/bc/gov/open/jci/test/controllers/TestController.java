package ca.bc.gov.open.jci.test.controllers;

import ca.bc.gov.open.jci.test.services.TestService;
import java.io.File;
...
public class TestController {
    ...
    public TestController(TestService testService) throws IOException {
        ...
        this.testService.setAuthentication(
                "CCDGetCivilFileContentSecure-soapui-project-template.xml");
        this.testService.setAuthentication("CCDCodeValuesSecure-soapui-project-template.xml");
    }
